...
### Checks
- Valid JSON syntax
- Canonical filename (`page_XXXX.json`)
- Filename/page/source-page consistency
- Required fields present
- No empty/null translations
- Sequential segment IDs
- Commentary structure and required keys
- UTF-8 encoding
- No unknown schema keys

### Output
```
✓ page_0020.json: Valid (7 segments, 12 commentary items)
✗ page_0021.json: INVALID
  - Missing required top-level field: notes
  - segments[0]: Missing field 'commentary'
```
...
3. **Compile** → Aggregate pages, then run chapter compiler
